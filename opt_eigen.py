...
def parse_args():
    ...
    parser.add_argument('--train_eigen', dest='train_eigen', help='train_eigen', default='False', type=str)
...
if __name__ == '__main__':
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as session:
        ...
        if args.train_eigen=='False': 
            ...
            cost_all = color_all +  0.4*edge_all + 0.0*real_all + 0.0*eigen_all
            ...
            for iteration in range(args.ITERS):
                ...
                _m_edge,_eigen_all,_x_c,_gx3, _m_c_o, _color_all,_real_all, _x_edge,_edge_all,_z_t,_gx, _cost, _cost_all, _ = session.run([m_edge,eigen_all,x_c,gx3, m_c_o,color_all,real_all,x_edge,edge_all,z_t,gx,cost,cost_all, invert_train_op], feed_dict=feed_dict)
                print(_x_edge.shape)
                print('colorall')                    
                print(_color_all)                    
                print('edgeall')                    
